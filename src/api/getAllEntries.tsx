...
export const getAllEntries = async (): Promise<GetAllEntriesResponse> => {
  try {
    ...
    const response = await fetch(
      `https://${process.env.REACT_APP_ASTRA_DB_ID}-${process.env.REACT_APP_ASTRA_DB_REGION}.apps.astra.datastax.com/api/rest/v2/namespaces/${process.env.REACT_APP_ASTRA_DB_KEYSPACE}/collections/${CONSTANTS.TASKS_COLLECTION}?page-size=100&profile=true`,
      {
        method: "GET",
        headers,
      }
